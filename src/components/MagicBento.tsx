...
const DEFAULT_GLOW_COLOR = '16, 185, 129'; // Green glow matching primary theme
...
const defaultCards: BentoCard[] = categories.map(cat => ({
  color: '#ffffff',
  title: cat.name,
  description: `Exceptional results in ${cat.name.toLowerCase()} for student projects.`,
  icon: cat.icon,
  label: 'Service',
  link: `/jobs?category=${encodeURIComponent(cat.name)}`
}));
